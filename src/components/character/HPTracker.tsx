...
export function HPTracker({ current, max }: HPTrackerProps) {
  ...
  return (
    <div className="flex flex-col items-center bg-stone-900 border border-stone-700 rounded-lg p-3 w-full">
      <span className="text-[10px] uppercase tracking-wider text-stone-400" aria-hidden="true">HP</span>
      <span
        ...
        aria-atomic="true"
      >
        {current}<span className="text-sm text-stone-400" aria-hidden="true">/{max}</span>
      </span>
      <div
        role="progressbar"
