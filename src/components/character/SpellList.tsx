            ...
            <div className="flex gap-4">
              {s.range && (
                <div className="flex items-baseline gap-1.5">
                  <span className="text-[10px] uppercase tracking-wider text-stone-400">Range</span>
                  <span className="text-xs text-stone-400">{s.range}</span>
                </div>
              )}
              {s.duration && (
                <div className="flex items-baseline gap-1.5">
                  <span className="text-[10px] uppercase tracking-wider text-stone-400">Duration</span>
...
export function SpellList({ spells }: SpellListProps) {
  return (
    <div>
      <h3 className="text-xs uppercase tracking-wider text-stone-400 mb-2">Spells</h3>
