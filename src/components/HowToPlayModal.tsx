      ...
      >
        ...
        <div className="flex-shrink-0 border-b border-stone-800 px-6 py-4 flex items-start justify-between">
          <div>
            ...
            <p className="mt-0.5 text-xs text-stone-400">Read this before you begin</p>
          </div>
          <button
            onClick={handleClose}
            className="ml-4 mt-0.5 text-stone-400 hover:text-white transition-colors cursor-pointer text-xl leading-none"
            aria-label="Close"
          >
            ×
          </button>
        ...
        <div className="flex-shrink-0 border-t border-stone-800 px-6 py-4 flex items-center justify-between gap-4">
          {showDismiss ? (
            <label className="flex items-center gap-2 cursor-pointer select-none">
              ...
              />
              <span className="text-xs text-stone-400">Don&apos;t show this again</span>
            </label>
          ) : (
            <span />
          )}
