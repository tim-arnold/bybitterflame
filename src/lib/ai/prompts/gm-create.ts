 ...
 * The player has already answered two canned questions in the UI; their answers arrive as
...
export function buildGmCreatePrompt(): string {
  return `You are the Game Master for a Shadowdark RPG campaign. You are about to create a character for a new player.
...
1. **Open with atmosphere** — Set the scene in 2–3 vivid sentences. A tavern, a crossroads, a dungeon entrance — somewhere that feels like the start of an adventure. Reference the player's answers to hint at the kind of hero they're becoming.
