      ...
      locations: [
        ...
        },
        {
          ...
          connections: [
            ...
            "West: cave passage to Freya's Camp (~30 ft)",
      ...
      locations: [
        {
          ...
          mapPosition: "Western end of the crypt; the staircase descends from ground level",
          dimensions: "Entry landing ~20×20 ft; stairs ~10 ft wide",
          connections: [
            "West: stone stairs up to ground level and the Voss family mausoleum above",
        ...
        },
        {
          ...
          mapPosition: "Central section of the crypt, running east-west",
          ...
          connections: [
            "West: archway to the Crypt Entrance (~10 ft)",
        ...
        },
        {
          ...
          mapPosition: "Eastern end of the crypt; fully submerged beyond the iron door",
        ...
        },
        {
          ...
          connections: [
            "Located within the Flooded Vault — no separate chamber; plugging it begins draining the entire crypt",
          ],
        },
      ],
      keyNPCs: [
      ...
      locations: [
        {
          ...
          dimensions: "Stone arch ~15 ft wide; the central garden path runs ~150 ft north to the Rafflesia",
          connections: [
            "South: surface road leading to the village (~10 min walk)",
            "North: central garden path through the Inner Grove (~60 ft to the Greenhouse, ~150 ft to the Rafflesia Heart)",
        ...
        },
        {
          ...
          connections: [
            ...
            "North: overgrown path continuing to the Rafflesia Heart (~90 ft)",
        ...
        },
        {
          ...
          dimensions: "The Rafflesia bloom is ~10 ft across; its attack reach extends 15 ft in all directions",
          connections: [
            ...
            "Beneath (ground level): the Moonbloom Hollow is accessible under the Rafflesia's root mass",
          ],
        ...
        },
        {
          ...
          mapPosition: "At ground level beneath the Rafflesia's root mass, north-center of the garden",
          dimensions: "A sheltered hollow ~5 ft across; accessible only by moving within the Rafflesia's reach",
          connections: [
            "Only accessible from within the Rafflesia's 15-ft reach zone; requires approaching the bloom directly",
          ],
        },
      ],
      keyNPCs: [
      ...
      locations: [
        ...
        },
        {
          ...
          connections: [
            ...
            "Southeast: to Aldric's Holding Chamber",
          ],
        ...
        },
        {
          ...
          connections: [
            ...
            "East: short passage (~20 ft) to Aldric's Holding Chamber",
    ...
    },
    {
      ...
      locations: [
        ...
        },
        {
          ...
          connections: [
            "West: iron keep entrance doors to the Fortress Courtyard",
        ...
        },
        {
          ...
          mapPosition: "Below the fortress, accessed via spiral stair from the Great Hall's south corridor",
        ...
        },
        {
          ...
          dimensions: "The entire well chamber (~80×60 ft) becomes the combat space; the Spirit cannot leave the fortress grounds",
          connections: [
    ...
    },
    {
      ...
      locations: [
        ...
        },
        {
          ...
          mapPosition: "East end of the tomb, the innermost chamber",
    ...
    },
    {
      ...
      locations: [
        ...
        },
        {
          ...
          connections: [
            "North: to Guild Storehouse Entry (~20 ft)",
    ...
    },
    {
      ...
      locations: [
        ...
        },
        {
          ...
          dimensions: "~40×30 ft chamber; ancient vault door set into the south wall (cracked open); the Void Creature fills the center",
          connections: [
            "North: the Deep Shaft tunnel back to the Upper Shafts (~80 ft)",
            "South wall: the ancient vault door (cracked — can be pushed shut with STR DC 15 while the creature is distracted)",
          ],
    ...
    },
    {
      ...
      locations: [
        ...
        },
        {
          ...
          mapPosition: "In the shrine nave near the floor crack; two templars are dead on the floor, Aldus is propped against the east wall",
          dimensions: "Located within the shrine nave; the fallen templars are scattered within 20 ft of the floor crack",
          connections: [
        ...
        },
        {
          ...
          dimensions: "Cyst chamber ~40 ft diameter; the Demon Cyst is 15 ft across and floats at center; the Cyst Warden orbits within 30 ft",
          connections: [
