...
export const characters = sqliteTable("characters", {
  ...
  toll: integer("toll").notNull().default(0),
  tollPermanent: integer("toll_permanent").notNull().default(0),
  gold: integer("gold").notNull().default(0),
  silver: integer("silver").notNull().default(0),
  copper: integer("copper").notNull().default(0),
  wyrd: integer("wyrd").notNull().default(0),
...
export const users = sqliteTable("user", {
  ...
  serverKeyTurnsBonus: integer("server_key_turns_bonus").notNull().default(0),
  ...
  // Haiku-specific token counts (subset of total*). Used to compute accurate costs
  // since Haiku is priced differently from Sonnet. total* - haiku* = Sonnet tokens.
  ...
  haikuCacheWriteTokens: integer("haiku_cache_write_tokens").notNull().default(0),
  haikuCacheReadTokens: integer("haiku_cache_read_tokens").notNull().default(0),
});
