...
An AI-powered Fantasy Adventure set in a folklore-inspired world. Create a character through a guided chat flow, then play through campaigns with Claude as your dungeon master. Sessions persist across days and weeks via AI-generated summaries.

Live beta: **[bybitterflame.com](https://bybitterflame.com)**
...
- **Selective rules loading** — only relevant rules loaded per turn based on game context
...
- **Resend** for transactional email (`gm@bybitterflame.com`)
...
src/
  ...
  lib/
    ...
    rules/               # Game rules as markdown (selectively loaded)
...
D1 schema: `wrangler d1 execute bitterflame --remote --file=schema.sql`
...
© 2025 Tim Arnold. You are free to view, fork, and modify this code. If you deploy it as a service, you must also make your source code available under the same license.
